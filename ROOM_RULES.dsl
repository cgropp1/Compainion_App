...
RULE "2x2_ARMOR"
    WHEN
        ...
        room.size.y == 2 && room.size.x == 2 && room.armor < 5
    THEN
        penalty(-1),
...
RULE "2x2_ARMOR_MIN"
    WHEN
        ...
        room.size.y == 2 && room.size.x == 2 && room.armor < 4
    THEN
        penalty(-4),
...
RULE "NON_POWERED_ARMOR"
    WHEN
        ...
        room.powered == false && room.armor > 0
    THEN
        penalty(-.5),
...
RULE "NON_POWERED_ARMOR_MAX"
    WHEN
        // Non-powered room has armor
        room.powered == false && room.armor < 2
    THEN
        penalty(-5),
        message("Non-powered rooms should not have armor")
